...
IF(NOT DEFINED _PACK_RPM_CMAKE_)
    ...
    IF(NOT PRJ_RPM_SPEC_IN_FILE STREQUAL "")
	IF(NOT EXISTS ${PRJ_RPM_SPEC_IN_FILE})
	    SET(PRJ_RPM_SPEC_IN_FILE "" CACHE FILEPATH "spec.in")
	ENDIF(NOT EXISTS ${PRJ_RPM_SPEC_IN_FILE})
    ENDIF(NOT PRJ_RPM_SPEC_IN_FILE STREQUAL "")

    IF(PRJ_RPM_SPEC_IN_FILE STREQUAL "")
	SET(_PRJ_RPM_SPEC_IN_FILE_SEARCH_NAMES  "${PROJECT}.spec.in" "project.spec.in")
	SET(_PRJ_RPM_SPEC_IN_FILE_SEARCH_PATH "${CMAKE_SOURCE_DIR}/SPECS" "SPECS" "." "${RPM_BUILD_TOPDIR}/SPECS")
	FIND_FILE(_PRJ_RPM_SPEC_IN_FILE NAMES ${_PRJ_RPM_SPEC_IN_FILE_SEARCH_NAMES} PATHS ${_PRJ_RPM_SPEC_IN_FILE_SEARCH_PATH})
	IF(_PRJ_RPM_SPEC_IN_FILE STREQUAL "_PRJ_RPM_SPEC_IN_FILE-NOTFOUND")
	    ...
	    SET(_manage_rpm_dependency_missing 1)
	    SET(PRJ_RPM_SPEC_IN_FILE "" CACHE FILEPATH "spec.in" FORCE)
	    SET(RPMBUILD_CMD "" CACHE FILEPATH "rpmbuild")
	ELSE(_PRJ_RPM_SPEC_IN_FILE STREQUAL "_PRJ_RPM_SPEC_IN_FILE-NOTFOUND")
	    SET(PRJ_RPM_SPEC_IN_FILE ${_PRJ_RPM_SPEC_IN_FILE} CACHE FILEPATH "spec.in" FORCE)
	ENDIF(_PRJ_RPM_SPEC_IN_FILE STREQUAL "_PRJ_RPM_SPEC_IN_FILE-NOTFOUND")
    ENDIF(PRJ_RPM_SPEC_IN_FILE STREQUAL "")
    SET(PRJ_RPM_SPEC_IN_FILE "${PRJ_RPM_SPEC_IN_FILE}" CACHE FILEPATH "spec.in" FORCE)
