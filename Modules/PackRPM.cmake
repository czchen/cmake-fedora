...
IF(NOT DEFINED _PACK_RPM_CMAKE_)
    ...
    FUNCTION(RPM_CHANGELOG_WRITE_FILE)
	INCLUDE(DateTimeFormat)

	FILE(WRITE ${RPM_CHANGELOG_FILE} "* ${TODAY_CHANGELOG} ${MAINTAINER} - ${PRJ_VER}-1")
	FILE(READ "${CMAKE_FEDORA_TMP_DIR}/ChangeLog.this" _changeLog_items)

	FILE(APPEND ${RPM_CHANGELOG_FILE} "_changeLog_items\n\n")
	FILE(READ ${RPM_CHANGELOG_PREV_FILE} CHANGELOG_PREV)
    ...
    ENDFUNCTION(RPM_CHANGELOG_WRITE_FILE)
