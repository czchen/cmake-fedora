...
IF(NOT DEFINED _MANAGE_MAINTAINER_TARGETS_CMAKE_)
	...
	IF(NOT "${${hostService}_BATCH_TEMPLATE}" STREQUAL "")
	    ...
	    SET(SOURCE_ARCHIVE_IGNORE_FILES ${SOURCE_ARCHIVE_IGNORE_FILES} ${hostService}_BATCH)
	...
	IF(_disabled EQUAL 0)
	    ...
	    ELSE("${SOURCE_VERSION_CONTROL}" STREQUAL "git")
		M_MSG(${M_OFF} "SOURCE_VERSION_CONTROL=${SOURCE_VERSION_CONTROL} is not valid, Source version control support disabled.")
