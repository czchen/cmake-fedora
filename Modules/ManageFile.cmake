...
MACRO(FIND_ERROR_HANDLING TYPE VAR)
	...
	FIND_PROGRAM(${VAR} ${_findFileArgList})
	SET(_type "Program")
	...
	M_MSG(${_verboseLevel} "${_type} cannot be found with following arguments: ${_str} ${_errorMsg}")
	IF (NOT _errorVar STREQUAL "")
	    SET(${_errorVar} 1)
	ENDIF(NOT _errorVar STREQUAL "")
    ENDIF(${VAR} STREQUAL "${VAR}-NOTFOUND")
ENDMACRO(FIND_ERROR_HANDLING TYPE VAR)
